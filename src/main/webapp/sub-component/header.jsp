...
<link rel="stylesheet" href="<c:url value="/assets/fonts/fontawesome-free-5.15.4-web/css/all.min.css"/>">
<link rel="stylesheet" href="<c:url value="/assets/css/jquery.desoslide.css"/>" />
<link rel="stylesheet" type="text/css" href="<c:url value="/assets/css/animate.min.css"/>">
<link href="<c:url value="/assets/css/scrolling-nav.css"/>" rel="stylesheet">
