...
public class Config {
    ...
    public static final String MAIL_PASSWORD = "xpsgmkfrxldvisra";

    public static final int OTP_LIVE= 300; // seconds

    // login with google


    public static final int PROMOTION_PRODUCT_NUMBER = 4;
    public static final int PRODUCT_TOP_SELLER_NUMBER = 20;
    public static final int PRODUCT_BEST_NEW_NUMBER = 4;
