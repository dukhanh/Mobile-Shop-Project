                ...
                <div class="row-account">
                    <div class="left-container">
                        ...
                        <div class="side-bar-content">
                            <ul>
                                <a href="../customer/account.jsp"><li class="slide-bar "><i class="fa fa-edit"></i><span>Thông tin tài khoản</span></li></a>
                                ...
                                <a href="../customer/profile-reset-password.jsp"> <li class="slide-bar"><i class="fas fa-lock"></i><span> Đổi mật khẩu</span></li></a>
                            </ul>
                        </div>
                    </div>
