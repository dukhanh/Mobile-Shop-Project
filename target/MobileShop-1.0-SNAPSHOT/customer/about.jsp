                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="counter-block">
                                    <div class="counter-icon">
                                        <img src="../assets/images/mobile_icon.png" alt="">
                                    </div>
                            ...
                            <div class="testimonial-carousel">
                                <div class="owl-carousel owl-three owl-theme">
                                    ...
                                    <div class="item">
                                        <div class="testimonial-block">
                                            <div class="testimonial-content">
                                                <p class="testimonial-text">“Công ty có một đội tuyển phục vụ rất tốt.
                                                    Họ
                                                    tư vấn cho tôi một cách tận tình khi tôi có khó khăn trong việc mua
                                                    sản
                                                    phẩm.”</p>
                                                <h4>George Walker</h4>
