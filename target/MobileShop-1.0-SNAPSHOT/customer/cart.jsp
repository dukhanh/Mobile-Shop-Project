    ...
    <div class="cart-content mt30 mb30">
        ...
        <form action="checkout" method="GET" onsubmit="return isChecked()">
            <table class="table" id="cart-table">
                ...
                <tr>
                    <th>
                        <div class="item-center pdl10"><label for="check-all"></label><input id="check-all"
                                                                                             type="checkbox"
                    ...
                    <tr>
                        <td>
                            <div class="item-center pdl10"><label>
                                <input type="checkbox" name="selected" value="${p.id}" class="checkbox-element checkbox-element-child">
                            </label></div>
                        </td>
                        <td>
            ...
            <div class="prices-summary">
                ...
                <div class="right-con">
                   ...
                   <button type="submit" onclick="checkIsSelect()" class="btn-default btn-checkout">Mua Hàng</button>
                </div>
            </div>
        </form>
    </div>
